...
public class HelpDialog extends Dialog {
  ...
  public void onCreate(Bundle savedInstanceState) {
        ...
        new WebViewClient() {
          ...
          public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url.startsWith("mailto:")) {
              ...
              emailIntent.setType("*/*");
              emailIntent.putExtra(Intent.EXTRA_SUBJECT, "ISTA Logger Feedback");
    ...
    String newhtml_code = Base64.encodeToString(helpText.getBytes(), Base64.NO_PADDING);
    help.loadData(newhtml_code,"text/html", "base64");
