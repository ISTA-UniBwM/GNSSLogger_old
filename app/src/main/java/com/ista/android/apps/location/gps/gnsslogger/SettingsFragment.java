...
public class SettingsFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    final Switch screenAlwaysOn = (Switch) view.findViewById(R.id.always_on);
    final TextView screenAlwaysOnLabel = (TextView) view.findViewById(R.id.screen_always_on);
      screenAlwaysOn.setChecked(false);
      screenAlwaysOnLabel.setText("Switch is OFF");
      screenAlwaysOn.setOnCheckedChangeListener(
              new OnCheckedChangeListener() {
                  ...
                  public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                      ...
                      if (isChecked) {
                          ...
                          screenAlwaysOnLabel.setText("Switch is ON");
                      } else {
